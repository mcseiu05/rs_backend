...
{
    public abstract class RSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RSDbContext, Task<T>> func)
        {
            T result;
