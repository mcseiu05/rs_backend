...
namespace RS.Migrations
{
    ...
    [Migration("20210221123403_Add-Appanel")]
    partial class AddAppanel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RS.Domain.AP.ApPanel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("RS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("RS.Authorization.Users.User", null)
                        .WithMany("Claims")
